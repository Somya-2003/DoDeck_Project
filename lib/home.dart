...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  String sqlCreate = "CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT, "
      ...
      onCreate: (db, version) async {
        await db.execute(
            "CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT,"
                " desc TEXT, completion REAL DEFAULT 0.0)");
      },
              ...
              Row(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    width: _isExpanded ? 170 : 150,
                    height: _isExpanded ? 170 : 150,
                    color: Colors.pink,
                    child: Center(
                      child: Text("Welcome",
                  ...
                  AnimatedContainer(
                    ...
                    curve: Curves.easeInOut,
                    margin: EdgeInsets.all(2),
                    width: _isExpanded ? 135 : 120,
                    height: _isExpanded ? 135 : 120,
              ...
              Row(
                ...
                children: [
                  AnimatedContainer(
                    ...
                    curve: Curves.easeInOut,
                    margin: EdgeInsets.all(2),
                    width: _isExpanded ? 130 : 110,
                    height: _isExpanded ? 130 : 110,
